...
def generate_sensor_reading(device_id, timestamp):
    temperature = round(random.uniform(85.1, 95.0), 2)      # WARNING temp
    vibration = round(random.uniform(1.01, 1.5), 2)         # WARNING vibration
    pressure = round(random.uniform(2.01, 2.5), 2)  
