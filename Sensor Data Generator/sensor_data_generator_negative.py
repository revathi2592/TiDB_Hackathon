...
def generate_sensor_reading(device_id, timestamp):
    temperature = round(random.uniform(40.0, 59.9), 2)        # WARNING temp
    vibration = round(random.uniform(1.51, 3.0), 2)         # WARNING vibration
    pressure = round(random.uniform(0.5, 0.99), 2)  
